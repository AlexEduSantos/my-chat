        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 gap-4 md:gap-6 mt-8 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mt-8 max-w-xl mx-auto">
            ...
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-4 mx-auto border border-white/20">
                <UsersIcon className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-white mb-2">Salas Públicas</h3>
            ...
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all">
              ...
              <h3 className="text-white mb-2">Conversas Privadas</h3>
              <p className="text-white/60 text-sm">
